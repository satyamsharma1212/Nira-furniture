          ...
          <div className="grid gap-12 lg:grid-cols-[0.65fr_1.35fr] lg:gap-24">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[12px] font-semibold uppercase tracking-[0.25em] text-[#725D3D]">
                  Our Philosophy
                </p>

                <p className="mt-4 max-w-[220px] text-[14px] font-medium leading-6 text-[#171512]/60">
      ...
      <section className="bg-[#E7DFD3]">
        ...
        <div className="mx-auto grid max-w-[1480px] lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-7 py-16 sm:px-12 sm:py-20 lg:px-20">
            ...
            <p className="text-[12px] font-semibold uppercase tracking-[0.25em] text-[#927344]">
              Our Story
            </p>
            ...
            <div className="mt-9 max-w-[500px] space-y-5">
              ...
              <p className="text-[15px] font-medium leading-7 text-[#171512]/70">
      ...
      <section className="px-6 py-24 sm:px-10 sm:py-28 lg:px-16 lg:py-36">
        ...
        <div className="mx-auto max-w-[1480px]">
          ...
          <div className="mb-12 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <p className="max-w-[320px] text-[14px] font-medium leading-7 text-[#171512]/60">
        ...
        <div className="mx-auto max-w-[1480px]">
          ...
          <div className="grid gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-24">
            ...
            <div>
              ...
              <p className="text-[12px] font-semibold uppercase tracking-[0.25em] text-[#B89A62]">
                Made in India
              </p>
            ...
            <div>
              ...
              <p className="mt-8 max-w-[600px] text-[16px] font-medium leading-8 text-[#F4F0E8]/65 sm:text-[17px]">
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="font-serif text-[19px] font-medium italic text-[#927344]">
          {number}
        </span>
      ...
      <p className="mt-4 max-w-[350px] text-[15px] font-medium leading-7 text-[#171512]/65">
        {text}
      </p>

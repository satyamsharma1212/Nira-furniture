...
export default function LoginPage() {
  ...
  Sign in to your NIRA account and continue exploring
  furniture designed for considered spaces.
</p>
  ...
  Sign in with your Google account to access your NIRA
  account.
</p>
  ...
  {loading ? "Connecting..." : "Continue with Google"}
           ...
           <span className="whitespace-nowrap font-sans text-[11px] font-medium uppercase tracking-[0.2em] text-3[#171512]/40">
  Secure sign in
</span>
...
<p className="font-sans text-xl font-semibold leading-9 text-[#171512]/65">
  Your Google account is securely authenticated through Supabase. NIRA never sees or stores your Google password.
</p>
  ...
  <span className="text-[#765A32]">
    Simply continue with Google to create your account.
  </span>
</p>
            </div>

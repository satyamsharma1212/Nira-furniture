  ...
  return (
    <main className="min-h-screen bg-[#FAF8F2] text-[#241F18]">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-82px)] max-w-3xl items-center justify-center px-6 py-16">
        <div className="w-full border border-[#241F18]/10 bg-white px-6 py-16 text-center sm:px-12">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-[#B8860B]/30 bg-[#FAF8F2]">
            <div className="h-7 w-7 animate-spin rounded-full border-2 border-[#241F18]/15 border-t-[#B8860B]" />
          </div>

          <p className="mt-7 text-[10px] font-bold uppercase tracking-[0.3em] text-[#B8860B]">
            Processing
          </p>
          ...
          <p className="mx-auto mt-5 max-w-md text-sm leading-7 text-[#756B5B]">
            We are preparing your order confirmation.
          </p>
        </div>
      </section>
    </main>
